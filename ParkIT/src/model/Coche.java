	...
	public void run() {
		...
		if (!permisoAparcamiento.equals("expirado")) {
			if (permisoAparcamiento.equals("permitido")) {
				...
				try {
					Thread.sleep(parking.getGeneradorTiempo().getDuracionEstanciaCochesNuevo() * 1_000);
				} catch (InterruptedException e) {
				}
				parking.getGeneradorTiempo()
						.setDuracionEstanciaCochesUsado(parking.getGeneradorTiempo().getDuracionEstanciaCochesNuevo());
